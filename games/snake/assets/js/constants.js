...
export const LEVELS = [
    ...
    { level: 3, displayName: "Now You See Me", initialSpeed: 5.5, objective: { type: 'REACH_LENGTH', amount: 15 }, obstacleMap: [ { type: 'blinking', x: Math.floor(COLS/2), y: 8 }, { type: 'blinking', x: Math.floor(COLS/2), y: 9 }, { type: 'blinking', x: Math.floor(COLS/2), y: 10 }, { type: 'blinking', x: Math.floor(COLS/2), y: ROWS - 9 }, { type: 'blinking', x: Math.floor(COLS/2), y: ROWS - 10 } ] }
];
