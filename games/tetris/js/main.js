...
function togglePause() {
    if (modalTitle.textContent === 'Game Over') return; // Cannot pause on game over screen
...
// These functions might already exist from your base file, ensure they look like this
function showModal(title, text, buttonText) {
    modalTitle.textContent = title;
    modalText.innerHTML = text;
    modalButton.textContent = buttonText;
    modal.classList.remove('hidden'); // Use hidden class
}
...
// Hide history if clicked outside
