// --- 1. Element Selectors (Based on your provided files) ---
...
// New selectors for the features
...
function togglePause() {
    // Don't allow pause on game over screen by checking the title
...
function gameLoop(now = 0) {
    if (isPaused) {
        requestId = requestAnimationFrame(gameLoop); // Keep loop "running" to be able to unpause
        return;
    }
...
// --- 6. Initial Setup ---
// The DOMContentLoaded wrapper ensures this runs after the HTML is ready.
